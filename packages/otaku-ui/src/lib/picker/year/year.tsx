  ...
  return (
    <>
      <ul className="otaku-datetime-picker-header">
        <li>
          <span className={`iconfont otaku-icon-doubleleft`} onClick={() => switchYear('year', 'left')}></span>
        </li>
        <li>
          <span>{`${year[1]} - ${year[10]}`}</span>
        </li>
        <li>
          <span className={`iconfont otaku-icon-doubleright`} onClick={() => switchYear('year', 'right')}></span>
        </li>
      </ul>
            ...
            return (
              <li
                ...
                className={`
                  ...
                  ${item === dayjs().year() ? 'otaku-datepicker-currentYear' : ''}
