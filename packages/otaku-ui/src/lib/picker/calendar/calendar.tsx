...
export function Calendar(props: CalendarProps) {
  ...
  const [selectDate, setSelectDate] = useState(dayjs(date).format("YYYY-M-D"))
            ...
            return item.map(children => {
              ...
              const isDisabled =
                typeof disabled === "function"
                  ? disabled(getDateResult(children, format))
                  : disabled
                ...
                <li
                  ...
                  className={classNames(
                    ["otaku-calender-date", "otaku-calendar-current"],
                    {
                      ...
                      "otaku-calendar-active": selectDate === children
                    }
                  )}>
