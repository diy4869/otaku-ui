...
import { Input, Avatar, Comment, Button, SpaceBetween, Rate } from 'bangumi-ui'
    ...
    <div className={playerStyle.player}>
        ...
        <div className={playerStyle.bottom}>
          ...
          <div className={playerStyle.commentCotainer}>
            <Comment>
              <Comment>
                <div className={playerStyle.replyContent}>
                  <Avatar size={35} ></Avatar>
                  <Input type="textarea" rows={3} className="reply"></Input>
